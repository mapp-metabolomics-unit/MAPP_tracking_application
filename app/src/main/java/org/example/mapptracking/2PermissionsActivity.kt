// 2)
// Permits to ask permissions needed for the application
...
class `2PermissionsActivity` : AppCompatActivity() {
    ...
    private val requestMultiplePermissions =
        registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions()) { _ ->
            ...
            if (permissionStatusLocation == PackageManager.PERMISSION_GRANTED
                ...
                val intent = Intent(this, `3_1PrinterConnectActivity`::class.java)
