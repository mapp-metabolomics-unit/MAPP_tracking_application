// 3.2)
// Page that manages the connection to the printer if the user wants to connect a printer
...
class `3_2ManagePrinterActivity` : AppCompatActivity(), PrinterUpdateListener, PrinterDiscoveryListener {
    ...
    private fun setPrinterDetails(new: String) {
        ...
        val intent = Intent(this, `3_3WaitConnectionActivity`::class.java)
