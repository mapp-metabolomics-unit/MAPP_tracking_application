// 3.3)
// Page that permits to wait a successful connection before redirecting to homepage if user connects a printer
...
class `3_3WaitConnectionActivity` : AppCompatActivity() {
